<?php
//Загрузка нового изображения для слайдера



// Название <input type="file">
$input_name = 'slider_img';
...
$lastSlideElement = getLastFile($dir);
echo $lastSlideElement;
include('../php/DB.php');
$slide_url = $dir . $lastSlideElement;
add_new_slide_url_on_DB($slide_url);


echo "<a href='./adminPanel.php?main_page_url=./index.php'><button>Назад</button></a>   <a href='auth/exit.php'><button>Главная страница</button></a>"
?>